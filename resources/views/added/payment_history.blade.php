<div
    x-data="{
        ...
        openReceipt(payment) {
            ...
            this.receipt.items            = payment.items || [];
            this.receipt.pdf_url          = null;
        ...
        async generatePdf() {
            ...
            try {
                const res = await fetch(`/payments/${this.receipt.receipt_number}/receipt-pdf`, {
                    headers: {
                ...
                if (data.success) {
                    this.receipt.pdf_url = data.receipt_url;
    ...
    <div x-show="showReceipt" x-transition x-cloak
        ...
        <div id="printableReceipt"
            ...
            <button type="button"
                ...
                <!-- Printer icon -->
                <svg x-show="!loadingPdf" xmlns="http://www.w3.org/2000/svg" width="28" height="28"
                ...
                <!-- Loading spinner -->
                <svg x-show="loadingPdf" class="animate-spin" width="28" height="28"
                    ...
                    <div class="col-span-5">
                        ...
                        <p class="text-[10px] text-gray-600" x-show="item.size || item.color">
                            ...
                            <span x-show="item.color">
                                | Color: <span x-text="colorNameFromHex(item.color)"></span>
                            </span>
                        </p>
                    </div>
            ...
            <div class="mt-3 flex justify-end">
                <div class="w-56 text-[11px] space-y-0.5">
                    <div class="flex justify-between">
                        <span>Subtotal</span>
                        <span>₱<span x-text="Number(receipt.amount || grandTotal()).toFixed(2)"></span></span>
                    </div>
                    ...
                    <div class="flex justify-between pt-1">
                        <span>Balance</span>
                        <span :class="Number(receipt.balance || paymentBalance || 0) > 0 ? 'text-red-600 font-semibold' : 'text-black font-semibold'">
            ...
            <div class="mt-4 text-[11px]">
                ...
                <p>Thank you for choosing Mariviles Graphic Studio.
                   Your positive feedback helps us continue providing quality service.</p>
            </div>
