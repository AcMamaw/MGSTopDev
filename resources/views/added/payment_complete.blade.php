...
<div x-show="showCompletePaymentModal" x-cloak x-transition
    ...
    <div @click.outside="showCompletePaymentModal = false"
        class="bg-white w-full max-w-xl rounded-xl shadow-2xl p-6 relative max-h-[90vh] overflow-y-auto">
...
<div x-show="showReceipt" x-transition x-cloak
    ...
    <div id="printableReceipt"
        ...
        <!-- Download PDF FAB (S3) -->
        <button type="button"
                @click="window.open(receipt.pdf_url, '_blank')"
                x-show="showReceipt && receipt.pdf_url"
        ...
        <div x-show="showReceipt && !receipt.pdf_url"
