<div x-data="{ 
    ...
    filterOrders() {
        ...
        if (query) {
            ...
            // Show initial empty state only if there are no orders AND no search query
      ...
      <div x-show="showOrderDetails2" x-transition x-cloak
        ...
        <div @click.away="showOrderDetails = false"
            ...
            <h2 class="text-2xl font-bold mb-6 text-gray-800 border-b pb-3">
                 Order Details - ID: <span class="text-black-600" x-text="'O' + selectedOrderId.toString().padStart(3, '0')"></span>
            </h2>
