        ...
        <form action="{{ route('login.submit') }}" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <input type="text" name="username" id="username" placeholder="Enter your username"
                    class="mt-1 block w-full px-4 py-2 border rounded-lg focus:ring-sky-500 focus:border-sky-500 border-gray-300" value="{{ old('username') }}">
            </div>
            <div>
            ...
            <button type="submit"
                class="w-full py-2 px-4 bg-sky-300 hover:bg-sky-700 text-white font-semibold rounded-lg transition">Login</button>
        </form>
